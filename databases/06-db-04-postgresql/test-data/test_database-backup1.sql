...
ALTER TABLE ONLY public.orders ATTACH PARTITION public.orders_1 FOR VALUES FROM (499) TO (2147483647);
...
--
-- Name: orders orders_title_price_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
