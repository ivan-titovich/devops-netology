...
> [Занизил показатели алертов чтобы сработа отправка на mail](src/3_grafana_x.png)
> 
> 
> [Уведомление](src/3_grafana_mail.png)
...
![Grafana_alerts](src/3_grafana_alerts.png)
